#/bin/bash
nvcc cuda_test.cu -o cuda_test.cu.o -c -O2 -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC
...
# py3.6 + TF1.4
g++ -std=c++11 op.cpp cuda_test.cu.o -o sample.so -shared -fPIC -I /home/lee/tensorflow/lib/python3.6/site-packages/tensorflow/include -I /usr/local/cuda/include -I /home/lee/tensorflow/lib/python3.6/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda/lib64/ -L/home/lee/tensorflow/lib/python3.6/site-packages/tensorflow -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
